...
function createWindow() {
  ...
  if (app.isPackaged) {
    // In packaged .exe, load the live Admin Panel URL to bypass Firebase file:// domain restrictions.
    // The preload script will still inject the FFmpeg controls securely.
    mainWindow.loadURL('https://next-step-admin-pannel.vercel.app/?admin=true');
  } else {
